...
TERMINAL_WEBSOCKET_POLL_SECONDS = float(
    os.environ.get("TERMINAL_WEBSOCKET_POLL_SECONDS", "0.35")
)
TERMINAL_WEBSOCKET_ALLOWED_ORIGINS = env_list(
    "TERMINAL_WEBSOCKET_ALLOWED_ORIGINS",
...
REMOTE_TERMINAL_WAIT_SECONDS = float(os.environ.get("REMOTE_TERMINAL_WAIT_SECONDS", "0.2"))
